...
// تابع ایجاد thumbnail از تصویر
function createImageThumbnail(url, maxWidth = 100, maxHeight = 100) {
    return new Promise((resolve, reject) => {
        const img = new Image();
        img.onload = function() {
            const canvas = document.createElement('canvas');
